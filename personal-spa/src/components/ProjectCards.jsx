      ...
      >
        ...
        <div className="mx-8">
          ...
          <p className="mb-4 drop-shadow-sm">
            ...
            progressive web application with ReactJS that utilized a minimum of
            two mobile device hardware APIs, which for this app was Geolocation
            and Webcam. The idea behind this app is to allow the user to report
            sightings of possible invasive species.
          </p>
          <a
            className="inline-block bg-blue-600 py-2 px-8 rounded-md uppercase font-semibold hover:shadow-md hover:shadow-slate-950 hover:bg-blue-500 transition ease-in-out delay-80"
